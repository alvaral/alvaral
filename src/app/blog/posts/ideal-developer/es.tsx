...
export default function IdealDeveloperPost() {
  return (
    <PostLayout title="El desarrollador de software ideal">
      ...
      <PostParagraph>
        Entonces, si por un momento tuviéramos que cerrar los ojos e imaginarnos
        al programador perfecto, ¿quién se te vendría a la mente? ¿Linus
        Torvalds? ¿Margaret Hamilton? ¿Mark Zuckerberg?
      </PostParagraph>

      <PostParagraph>
        Todos ellos fueron –y son– programadores brillantes. Ya sea creando
        Linux, el software del Apolo 11 que llevó al hombre a la luna, o una red
        social que cambió el mundo. Sin embargo, sería irreal pensar que nunca
        cometieron errores o que sus cualidades actuales representan un estándar
        absoluto.
      </PostParagraph>
      ...
      <PostParagraph className="mb-8">
        Sea como sea, la figura del ingeniero de software ideal debería de tener
        una serie de características para poder considerarse el programador
        perfecto. Aquí intento deducir cuáles serían.
      </PostParagraph>
      ...
      <HighlightedParagraph>
        ...
        específicas que permiten ejecutar tareas concretas relacionadas con una
        profesión.
      </HighlightedParagraph>

      <PostParagraph>
        En el caso del desarrollo de software, estas habilidades te permiten
        construir, mantener y mejorar productos tecnológicos de forma eficiente,
        segura y escalable. Ya sabes, todas esas que nos enseñan en la
        universidad.
      </PostParagraph>

      <PostParagraph>
        Podríamos escribir libros sobre esto (y los hay), pero resumiré algunas
      ...
      <PostParagraph>
        Wow, esto ya es un poco más jodido… pero aun así, cuando lo entiendes se
        hace muy entretenido. Para saber esto se necesitan haber dominado los
        fundamentos de programación de antes (y los puedes aprender a la vez).
      </PostParagraph>
      ...
      <PostParagraph>
        No basta con que el código funcione una vez (y si no, pregúntaselo a los
        testers). Las pruebas aseguran que sigue funcionando después de varios
        cambios. Saber testear (unitariamente, de integración, e2e…) es tan
        importante como saber crear nuevo código y una muy mala práctica es
        dejarse llevar por las prisas y no hacer los tests.
      </PostParagraph>
      ...
      <PostParagraph className="mb-10">
        ...
        entiendes, pero te pagan por arreglarlo. El debugging es la herramienta
        que nos permite entender qué falló, por qué y cómo solucionarlo sin
        perder horas dando vueltas.
      </PostParagraph>

      <PostHeading level={1}>Habilidades blandas</PostHeading>

      <HighlightedParagraph>
        Las habilidades blandas (o soft skills) son las capacidades personales e
        interpersonales que hacen la comunicación, colaboración y adaptación en
        distintos entornos laborales y sociales.
      </HighlightedParagraph>

      <PostParagraph>
        Es lo que podría definirse como aquello que nos hace humanos. O como yo
        digo, no ser &quot;un capullo&quot;. Por ejemplo, se podría decir que
        Sheldon Cooper no tiene muchas habilidades blandas (aunque sea un genio,
        no se lleva bien con los demás y eso le limita laboralmente). Puedes ser
        el mejor programador del mundo, pero si no sabes comunicarte, colaborar
        o adaptarte, tu impacto será limitado.
      </PostParagraph>

      <PostHeading level={2}>Comunicación</PostHeading>

      <PostParagraph>
        Saber explicar una idea técnica a alguien no técnico (o técnico de otra
        área) es un superpoder. ¿O acaso te crees que tu manager o el cliente
        van a saber al dedillo la tecnología por la que te pagan? La buena
        comunicación facilita el trabajo, reduce malentendidos y mejora los
        resultados.
      </PostParagraph>
      ...
      <PostParagraph>
        ...
        Saber colaborar, escuchar, dar y recibir feedback es lo que convierte a
        un buen programador en un gran compañero.
      </PostParagraph>
      ...
      <PostHeading level={2}>Principios de diseño y buenos hábitos</PostHeading>

      <PostParagraph>
        Escribir código que otros puedan entender y mantener es un arte. Seguir
        principios como SOLID, patrones de diseño o mantener una arquitectura
        limpia puede marcar la diferencia entre una solución elegante y un
        infierno de deuda técnica.
      </PostParagraph>
      ...
      <PostParagraph>
        Esa es, de hecho, la diferencia entre un aficionado y un profesional. El
        aficionado hace algo por pasión, cuando le apetece; cuando no le
        apetece, simplemente no lo hace. El profesional, en cambio, lo hace
        incluso cuando no tiene ganas. ¿O acaso querrías que el médico que te va
        a operar solo haga bien su trabajo los días que está de buen humor?
      </PostParagraph>

      <PostParagraph>
        La constancia absoluta es una ilusión. Lo real, lo admirable, es seguir
        adelante incluso cuando fallamos o no estamos en nuestro mejor momento.
      </PostParagraph>
